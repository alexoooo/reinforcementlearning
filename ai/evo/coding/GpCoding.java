...
public class GpCoding implements Coding
{
    ...
    public GpCoding(
            boolean      isStatic,
            GpDispatcher messageDispatcher)
    {
    ...
    {
        return firstArgAsInstance
               ? dependencies[0].express()
               : null;
    }
    ...
    public Product encode(Gene... dependencies)
    {
        return dispatcher.dispatch(
                instance(dependencies), args(dependencies));
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return firstArgAsInstance == gpCoding.firstArgAsInstance &&
               dispatcher.equals(gpCoding.dispatcher);
    }
